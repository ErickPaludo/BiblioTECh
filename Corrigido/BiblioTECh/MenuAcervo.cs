        ...
        public void Adicionar()
        {
            ...
            switch (entrada)
            {
                case 1:
                    ...
                    acervo.Insere(new Livro(auxautor, auxeditora, auxpag, auxident, auxtitulo, "Disponivel"));
                    break;
                case 2:
                    ...
                    acervo.Insere(new Periodico(auxperiodicidade, auxnumero, auxano, auxident, auxtitulo, "Disponivel"));
                    break;
                case 3:
                    ...
                    acervo.Insere(new Dvd(auxassunto, auxduracao, auxident, auxtitulo, "Disponivel"));
                    break;
                default:
                    Console.Clear();
                    Console.WriteLine("opcao incorreta");
